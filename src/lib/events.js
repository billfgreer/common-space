...
export const EVENTS = [
  ...
  // ── 2025 ────────────────────────────────────────────────────────────────────
  {
    ...
    center: [-99.1, 29.9],
    zoom: 9,
    bbox: [-99.8, 29.2, -98.3, 30.6],
    catalogUrl: `${BASE}/Texas-Flooding-July-2025/collection.json`,
    imageCount: 20,
    thumbGradient: 'linear-gradient(150deg,#4A6A9B,#2E5A8A,#8B7A4A,#4A7AAD)',
    impact: { deaths: 35, displaced: 12000, homesDestroyed: 600, costUSD: 5000 },
    hdxLayers: [
      {
        name: 'Texas Admin Boundaries (ADM1)',
        url: 'https://raw.githubusercontent.com/wmgeolab/geoBoundaries/main/releaseData/gbOpen/USA/ADM1/geoBoundaries-USA-ADM1.geojson',
        urlType: 'direct',
...

  {
    ...
    location: 'Benue & Niger States, Nigeria',
    ...
    impact: { deaths: 48, displaced: 300000, homesDestroyed: 25000, costUSD: 80 },
    country: 'ng',
  },
...

  {
    ...
    name: 'Typhoon Yagi 2024',
    location: 'Northern Vietnam & Philippines',
    eventDate: '2024-09-07',
    type: 'Typhoon',
    emoji: '🌀',
    center: [106.0, 20.5],
    zoom: 8,
    bbox: [104.5, 19.0, 108.0, 22.5],
    catalogUrl: `${BASE}/Typhoon-Yagi-Vietnam-Sept-2024/collection.json`,
    imageCount: 25,
    thumbGradient: 'linear-gradient(130deg,#2D6A8E,#4A9BAD,#3A7A4E,#6BAAAD)',
    impact: { deaths: 700, displaced: 600000, homesDestroyed: 50000, costUSD: 3200 },
  },
  ...
  {
    id: 'herat-earthquake-2023',
    name: 'Herat Earthquake 2023',
    ...
    center: [62.0, 34.3],
    zoom: 10,
    bbox: [61.2, 33.5, 62.8, 35.1],
    catalogUrl: `${BASE}/Afghanistan-Herat-Earthquake-Oct2023/collection.json`,
    imageCount: 20,
    thumbGradient: 'linear-gradient(135deg,#6B5B45,#8B7355,#9B8B6A,#7A7A6A)',
    impact: { deaths: 1400, displaced: 45000, homesDestroyed: 17000, costUSD: 400 },
    country: 'af',
    hdxLayers: [
      {
        name: 'ShakeMap — M6.3 Herat Intensity',
        url: 'us7000lalf',
        urlType: 'usgs-shakemap',
        format: 'GeoJSON', type: 'shakemap', source: 'USGS',
      },
